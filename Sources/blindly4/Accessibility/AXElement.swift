...
func requireAccessibility() throws {
    guard AXIsProcessTrusted() else {
        throw CLIError.permissionDenied("Accessibility access is not enabled. Run `blindly4 request-permission`, then enable your terminal in System Settings > Privacy & Security > Accessibility.")
    }
}
