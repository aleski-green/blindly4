...
func usage() -> String {
    ...
    For a multi-command workflow, acquire a service-wide lease with `lease acquire`, then
    pass `--lease TOKEN` to every command (reads included), and finish with `lease release`.
